...
namespace Application.Tests
{
    public class Tests
    {
        ...
        public void Calculate_PriceWhileSpentLowAtOnes_TheSmallestDiscount()
        {
            ...
            var discount = new DiscountWithDate(customerMock.Object) {Price = 100, ValidFrom = DateTime.Now.AddDays(-1), ValidTo = DateTime.Now.AddDays(1)};
        ...
        public void Calculate_PriceWhileSpentHighAtOnes_TheHighestDiscount()
        {
            ...
            var discount = new DiscountWithDate(customerMock.Object) {Price = 100000, ValidFrom = DateTime.Now.AddDays(-1), ValidTo = DateTime.Now.AddDays(1)};
            _ = discount.Calculate();
            Assert.AreEqual(priceExpected, discount.Price);
        }
        ...
        public void Calculate_DiscountOutDated_NoneDiscount()
        {
            ...
            var discount = new DiscountWithDate(customerMock.Object) {Price = 100, ValidFrom = DateTime.Now.AddDays(-2), ValidTo = DateTime.Now.AddDays(-1)};
            _ = discount.Calculate();
            Assert.AreEqual(priceExpected, discount.Price);
        }
    }
